...
$connectionInfo = array( "Database"=>"QuranV2", "CharacterSet" => "UTF-8");
...
{
	global $connection;		
	$query = "EXEC getAyahSimilarity2 ".$surahNumber.",".$ayahNumber.",".$sentence1Percentage.",".$sentence2Percentage.",".$connectedness1.",".$connectedness2.",".$orderness;
    $result = sqlsrv_query($connection, $query) or die("Query fail: " . print_r( sqlsrv_errors(), true));	
